...
![](/post-images/develop/undefined-vs-null-vs-nan/1.png)
...
- 변수에 값을 할당하지 않았을 때
  ![case1](/post-images/develop/undefined-vs-null-vs-nan/2.png)

- 함수가 값을 반환하지 않았을 때
  ![case2](/post-images/develop/undefined-vs-null-vs-nan/3.png)

- 객체에 없는 속성에 접근
  ![case3](/post-images/develop/undefined-vs-null-vs-nan/4.png)

- 배열에 존재하지 않는 인덱스에 접근
  ![case4](/post-images/develop/undefined-vs-null-vs-nan/5.png)

- 함수의 파라미터로 전달되지 않은 인수
  ![case5](/post-images/develop/undefined-vs-null-vs-nan/6.png)
