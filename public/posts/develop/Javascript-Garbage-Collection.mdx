...
![major-gc](/post-images/javascript/Javascript-Garbage-Collection/1.gif)
...
![Parallel-gc](/post-images/javascript/Javascript-Garbage-Collection/2.png)

### Incremental

- Matin Thread에서 GC 작업을 작은 단위로 나누어 프로그램을 수행하며 중간중간 실행

![Incremental-gc](/post-images/javascript/Javascript-Garbage-Collection/3.png)
...
![Concurrent-gc](/post-images/javascript/Javascript-Garbage-Collection/4.png)
